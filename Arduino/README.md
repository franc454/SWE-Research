...
The Ultimate GPS provides a library of files to receive data from the Ultimate GPS.  Echo is a file that takes this data and sends it to the Serial Monitor.  This data contains time, elevation angle, azimuth, signal strength, etc.  Using a serial port monitor called 'RS232 Data Logger' from Eltima, I was able to save the output from the Ultimate GPS into .txt files.  Examples of these files are in the plot_LWC folder under the names hour_test_1.txt and hour_test_2.txt.  
